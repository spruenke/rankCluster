...
RcppExport SEXP _rankCluster_rcpparma_hello_world() {
BEGIN_RCPP
...
RcppExport SEXP _rankCluster_rcpparma_outerproduct(SEXP xSEXP) {
BEGIN_RCPP
    Rcpp::RObject rcpp_result_gen;
    Rcpp::RNGScope rcpp_rngScope_gen;
...
RcppExport SEXP _rankCluster_rcpparma_innerproduct(SEXP xSEXP) {
BEGIN_RCPP
    Rcpp::RObject rcpp_result_gen;
    Rcpp::RNGScope rcpp_rngScope_gen;
    Rcpp::traits::input_parameter< const arma::colvec& >::type x(xSEXP);
...
RcppExport SEXP _rankCluster_rcpparma_bothproducts(SEXP xSEXP) {
BEGIN_RCPP
    Rcpp::RObject rcpp_result_gen;
    Rcpp::RNGScope rcpp_rngScope_gen;
    Rcpp::traits::input_parameter< const arma::colvec& >::type x(xSEXP);
...
static const R_CallMethodDef CallEntries[] = {
    {"_rankCluster_rcpparma_hello_world", (DL_FUNC) &_rankCluster_rcpparma_hello_world, 0},
    {"_rankCluster_rcpparma_outerproduct", (DL_FUNC) &_rankCluster_rcpparma_outerproduct, 1},
    {"_rankCluster_rcpparma_innerproduct", (DL_FUNC) &_rankCluster_rcpparma_innerproduct, 1},
    {"_rankCluster_rcpparma_bothproducts", (DL_FUNC) &_rankCluster_rcpparma_bothproducts, 1},
